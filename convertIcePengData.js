...
data_list = [
	...
	},
	{
		...
		pickRatio: 63000,
		range: [0, 0],
		descriptions: ["이번에는 <{0}> 효과를 연성해주지.", "이번에는 <{0}> 효과를 연성하겠네.", "이번에는 <{0}> 효과를 연성해드리죠."],
		slotType: 3,
		type: "common",
		applyLimit: 99,
		logics: [
	...
	},
	{
		...
		pickRatio: 63000,
		range: [0, 0],
		descriptions: ["이번에는 <{1}> 효과를 연성해주지.", "이번에는 <{1}> 효과를 연성하겠네.", "이번에는 <{1}> 효과를 연성해드리죠."],
		slotType: 3,
		type: "common",
		applyLimit: 99,
		logics: [
	...
	},
	{
		...
		pickRatio: 63000,
		range: [0, 0],
		descriptions: ["이번에는 <{2}> 효과를 연성해주지.", "이번에는 <{2}> 효과를 연성하겠네.", "이번에는 <{2}> 효과를 연성해드리죠."],
		slotType: 3,
		type: "common",
		applyLimit: 99,
		logics: [
	...
	},
	{
		...
		pickRatio: 63000,
		range: [0, 0],
		descriptions: ["이번에는 <{3}> 효과를 연성해주지.", "이번에는 <{3}> 효과를 연성하겠네.", "이번에는 <{3}> 효과를 연성해드리죠."],
		slotType: 3,
		type: "common",
		applyLimit: 99,
		logics: [
	...
	},
	{
		...
		pickRatio: 63000,
		range: [0, 0],
		descriptions: ["이번에는 <{4}> 효과를 연성해주지.", "이번에는 <{4}> 효과를 연성하겠네.", "이번에는 <{4}> 효과를 연성해드리죠."],
		slotType: 3,
		type: "common",
		applyLimit: 99,
		logics: [
	...
	},
	{
		...
		pickRatio: 50000,
		range: [0, 0],
		descriptions: ["이번에는 <2>개의 효과를 동시에 연성하겠어.", "이번에는 <2>개의 효과를 연성하겠네.", "이번에는 <2>개의 효과를 동시에 연성해드리죠."],
		slotType: 3,
		type: "common",
		applyLimit: 99,
		logics: [
	...
	},
	{
		...
		pickRatio: 240000,
		range: [5, 99],
		descriptions: ["<임의의 효과>를 <1>개 봉인할 거야.", "임의의 효과를 <1>개 봉인하겠네.", "<임의의 효과> <1>개가 봉인될 거에요."],
		slotType: 3,
		type: "common",
		applyLimit: 99,
		logics: [
	...
	},
	{
		...
		pickRatio: 350000,
		range: [0, 0],
		descriptions: ["이번 연성에서 비용이 들지 않겠어.", "이번 연성에는 비용 소모가 없을 걸세.", "이번 연성에는 비용이 들지 않을 거예요."],
		slotType: 3,
		type: "common",
		applyLimit: 99,
		logics: [
	...
	},
	{
		...
		pickRatio: 1,
		range: [0, 0],
		descriptions: ["(현자가 명상에 잠겨 있습니다.)", "(현자가 명상에 잠겨 있습니다.)", "(현자가 명상에 잠겨 있습니다.)"],
		slotType: 3,
		type: "exhausted",
		applyLimit: 99,
		logics: [],
	},
	{
		...
		pickRatio: 1,
		range: [0, 0],
		descriptions: ["(현자가 회복 중입니다.)", "(현자가 회복 중입니다.)", "(현자가 회복 중입니다.)"],
		slotType: 3,
		type: "exhausted",
		applyLimit: 99,
		logics: [],
	},
	{
		...
		pickRatio: 1,
		range: [0, 0],
		descriptions: ["(현자가 휴식을 취하고 있습니다.)", "(현자가 휴식을 취하고 있습니다.)", "(현자가 휴식을 취하고 있습니다.)"],
		slotType: 3,
		type: "exhausted",
		applyLimit: 99,
		logics: [],
	},
	{
		...
		pickRatio: 1,
		range: [0, 0],
		descriptions: ["(현자가 고뇌에 빠져 있습니다.)", "(현자가 고뇌에 빠져 있습니다.)", "(현자가 고뇌에 빠져 있습니다.)"],
		slotType: 3,
		type: "exhausted",
		applyLimit: 99,
		logics: [],
	},
	{
		...
		pickRatio: 1,
		range: [0, 0],
		descriptions: ["(현자는 조언을 숙고중입니다.)", "(현자는 조언을 숙고중입니다.)", "(현자는 조언을 숙고중입니다.)"],
		slotType: 3,
		type: "exhausted",
		applyLimit: 99,
		logics: [],
	},
	{
		...
		pickRatio: 1,
		range: [0, 0],
		descriptions: ["(현자는 새로운 연구를 진행중입니다.)", "(현자는 새로운 연구를 진행중입니다.)", "(현자는 새로운 연구를 진행중입니다.)"],
		slotType: 3,
		type: "exhausted",
		applyLimit: 99,
		logics: [],
	},
	{
		...
		pickRatio: 1,
		range: [0, 0],
		descriptions: ["(현자는 묵상에 빠져 있습니다.)", "(현자는 묵상에 빠져 있습니다.)", "(현자는 묵상에 빠져 있습니다.)"],
		slotType: 3,
		type: "exhausted",
		applyLimit: 99,
		logics: [],
	},
	{
		...
		pickRatio: 1,
		range: [0, 0],
		descriptions: ["(현자는 사색에 빠져 있습니다.)", "(현자는 사색에 빠져 있습니다.)", "(현자는 사색에 빠져 있습니다.)"],
		slotType: 3,
		type: "exhausted",
		applyLimit: 99,
		logics: [],
	...
	},
	{
		...
		pickRatio: 500000,
		range: [0, 0],
		descriptions: ["이번 연성은 연성 기회를 소모하지 않아.", "이번 연성은 기회 소모 없이 진행해주겠네.", "이번에는 기회를 소모하지 않고 연성할게요."],
		slotType: 3,
		type: "lawful",
		applyLimit: 99,
		logics: [
	...
	},
	{
		...
		pickRatio: 150000,
		range: [0, 0],
		descriptions: ["<최고 단계> 효과의 단계를 <2> 올려주지.", "<최고 단계> 효과의 단계를 <2> 올리겠네.", "<최고 단계> 효과의 단계를 <2> 올려드리죠."],
		slotType: 3,
		type: "lawful",
		applyLimit: 99,
		logics: [
	...
	},
	{
		...
		pickRatio: 2000000,
		range: [0, 0],
		descriptions: ["남은 모든 연성에서 비용이 들지 않겠어.", "남은 모든 연성에서 비용 소모가 없을 걸세.", "이후 모든 연성에서 비용이 들지 않을 거에요."],
		slotType: 3,
		type: "lawful",
		applyLimit: 1,
		logics: [
	...
	},
	{
		...
		pickRatio: 100000,
		range: [0, 0],
		descriptions: ["<네가 고르는> 효과를 봉인하겠다.", "<자네가 선택한> 효과를 봉인하겠네.", "<당신이 택한> 효과를 봉인해드리죠."],
		slotType: 3,
		type: "lawful",
		applyLimit: 99,
		logics: [
...
new_items = JSON.stringify(data_list)

fs.writeFile("dataJson.py", new_items, (error) => {
	if (error) {
		console.error(error)
		throw error
	}
